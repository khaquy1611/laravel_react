...
import { TRealEstateTypePayloadInput } from '../../setting'

import { yupResolver } from '@hookform/resolvers/yup'
import * as yup from 'yup'

/* SERVICE */
import { getObjectById, save, IObject } from '@/services/RealEstateTypeService'
...
const Store = ({ id, action, closeSheet }: StoreProps) => {
  ...
  const methods = useForm<TRealEstateTypePayloadInput>({
    context: { action },
      ...
      <form onSubmit={handleSubmit(onSubmitHanler)}>
        <div className="grid gap-4 py-4">
          ...
          <CustomInput
            ...
            name="canonical"
            type="text"
            defaultValue={data && data.canonical}
          />
        </div>
