...
/* SERVICE */
import { pagination, destroy } from '@/services/AttributeCatalogueService'
import { useSearchParams } from 'react-router-dom'
import { breadcrumbs, Models } from '@/constants'

const AttributeCatalogue = () => {
  const breadcrumbData: Breadcrumb = breadcrumbs.attribute_catalogues.index
  const model = Models.attribute_catalogues
  const {
    isLoading,
    data,
    isError,
        ...
        <Card className="rounded-[5px] mt-[15px]">
          ...
          <CardContent className="p-[15px]">
            <Filter
              ...
              openSheet={openSheet}
              items={filterItems}
              buttonText="Thêm mới nhóm thuộc tính"
            />
          ...
          <CustomSheet
            title={
              isSheetOpen.action === 'update'
                ? breadcrumbs.attribute_catalogues.update.title
                : breadcrumbs.attribute_catalogues.create.title
            }
...
export default AttributeCatalogue
